...
var pJS = function(e, a) {
    ...
    a && Object.deepExtend(i, a), i.tmp.obj = {
        ...
        var e = this;
        if (void 0 != e.radius_bubble) a = e.radius_bubble;
        else var a = e.radius;
        if (void 0 != e.opacity_bubble) t = e.opacity_bubble;
        else var t = e.opacity;
        if (e.color.rgb) s = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," + e.color.rgb.b + "," + t + ")";
        else var s = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," + e.color.hsl.l + "%," + t + ")";
        switch (i.canvas.ctx.fillStyle = s, i.canvas.ctx.beginPath(), e.shape) {
            ...
            case "star":
                ...
                break;
            case "image":
                if ("svg" == i.tmp.img_type) n = e.img.obj;
                else var n = i.tmp.img_obj;
        ...
        for (var e = 0; e < i.particles.array.length; e++) {
            ...
            if (i.particles.opacity.anim.enable && (1 == a.opacity_status ? (a.opacity >= i.particles.opacity.value && (a.opacity_status = !1), a.opacity += a.vo) : (a.opacity <= i.particles.opacity.anim.opacity_min && (a.opacity_status = !0), a.opacity -= a.vo), a.opacity < 0 && (a.opacity = 0)), i.particles.size.anim.enable && (1 == a.size_status ? (a.radius >= i.particles.size.value && (a.size_status = !1), a.radius += a.vs) : (a.radius <= i.particles.size.anim.size_min && (a.size_status = !0), a.radius -= a.vs), a.radius < 0 && (a.radius = 0)), "bounce" == i.particles.move.out_mode) s = {
                x_left: a.radius,
                x_right: i.canvas.w,
                y_top: a.radius,
                y_bottom: i.canvas.h
        ...
        function t(a, t, s, n, r) {
            if (a != t)
                if (i.tmp.bubble_duration_end) {
                    if (void 0 != s) {
                        o = a + (a - (n - p * (n - a) / i.interactivity.modes.bubble.duration)), "size" == r && (e.radius_bubble = o), "opacity" == r && (e.opacity_bubble = o)
                    }
        ...
        var a = i.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function(a, t, i, s) {
                if (e.color.rgb) n = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," + e.color.rgb.b + "," + e.opacity + ")";
...
Object.deepExtend = function(e, a) {
    ...
    s.className = "particles-js-canvas-el", s.style.width = "100%", s.style.height = "100%";
